...
````{admonition} Proof
:class: dropdown tip
[Sketch]  We~briefly explain why the fixpoint computation terminates and refer
...
%Hence, this operator allows us to express the states that can be controlled%operator exists and can be computed. %See also Tripakis et al. before 2005.
