...
tries to minimise it.%the form $(v,c,v')$ with $c$ a real number giving the weight of the%tries to minimise it. 
...
%quantitative games, we will focus on methods to solve the games,%$v$ and a threshold $x\in \Q$: this answers the question whether Eve%Adam is playing. We will also give algorithms computing the vector of