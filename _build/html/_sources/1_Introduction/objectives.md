...
%The induced B&uuml;chi condition is $\Buchi[\col] = \set{\play \in \Paths_\omega : \forall j, \exists i \ge j, \col(\rho_i) = 2}$.
...
%The induced CoB&uuml;chi condition is $\CoBuchi[\col] = \set{\play \in \Paths_\omega : \exists j, \forall i \ge j, \col(\rho_i) \neq \Lose}$.
