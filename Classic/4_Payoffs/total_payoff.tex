...
\begin{definition}\label{4-def:fairly-mixing}
...
\begin{theorem}[\cite{Gimbert&Zielonka:2004}]\label{4-thm:fairly-mixing}
...
\begin{theorem}[\cite{Brihaye&Geeraerts&HaddadA&Monmege:2017}]\label{4-thm:TP-optimal-strategies}
