...
\begin{theorem}[\cite{Zwick&Paterson:1996}]\label{4-thm:discounted}
...
\begin{theorem}[\cite{Jurdzinski:1998}]\label{4-thm:disc-up}
...
\begin{algorithm}
 ...
 $\Value^\sigma \leftarrow $ fixed-point of $F_\sigma$  \tcp*{by~\cref{4-lem:one-player-DP}}
...
\begin{lemma}\label{4-lem:rational-discounted}
...
approximation:
\begin{theorem}[\cite{Zwick&Paterson:1996}]\label{4-thm:MP-Zwick-Paterson}
