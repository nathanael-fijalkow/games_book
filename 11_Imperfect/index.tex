...
\begin{theorem}
\label{theo:qdet}
Stochastic games with signals and reachability, safety and B\"uchi
...
%stochastic B\"uchi games with signals do not have a
...
\begin{theorem}[Deciding almost-sure winning in B\"uchi games]
