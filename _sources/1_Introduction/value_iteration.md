...
```{prf:property} needs label Characterisation of the winning regions
:label: Characterisation of the winning regions
:nonumber:
...
```{prf:property} needs label Fixed point
:label: Fixed point
:nonumber:
...
```{prf:property} needs label Fixed point through contraction
:label: Fixed point through contraction
:nonumber:
...
```{prf:property} needs label Fixed point through monotonicity
:label: Fixed point through monotonicity
:nonumber:
...
```{prf:property} needs label Characterisation of the winning regions, equivalent formulation with progress measures
:label: Characterisation of the winning regions, equivalent formulation with progress measures
:nonumber:
