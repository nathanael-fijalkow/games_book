...
\begin{lemma}[Simulation]\label{12-fact-mono}
...
$v_0\in\WE$ and $v_0\leq v'_0$ imply $v_0'\in\WE$.  \Cref{12-fact-mono}
...
\cpageref{12-fig-cov}, $\loc'(0,1)\in\WE$ but $\loc'(1,2)\in\WA$ for
...
% \cref{12-pb-cov}, $\|\vec v\|$ is "viable" if $\loc(\vec v)$ is the
% target configuration, while for \cref{12-pb-nonterm,12-pb-parity},
% $0$~is "viable".
...
\begin{example}
  ...
  \cpageref{12-fig-avg}.  For the "coverability game" with target
...
\begin{example}\label{12-ex-pareto}
