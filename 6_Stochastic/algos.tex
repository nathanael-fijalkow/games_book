...
\begin{proof}
  ...
  \begin{proof}
    ...
    % ~\cref{6-lem:lemma2}. Hence it is omitted.
...
\label{6-subsubsec:algo-strat-improv}
...
\begin{proof}
%  \pat{J'esp\`ere ne pas m'\^etre embrouill\'ee avec toutes ces notations $\val$...}
...
\end{lemma}
  ...
  % By ~\cref{6-lem:croissant}, we deduce that $\perm'$ is
