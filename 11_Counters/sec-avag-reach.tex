...
\begin{theorem}\label{12-th-asym-undec}
...
\begin{proof}
  ...
  \begin{figure}[htbp]
    ...
    \end{tikzpicture}
    \caption{\label{12-fig-asym-undec}Schema of the reduction in the proof of \cref{12-th-asym-undec}.}
  \end{figure}
  ...
  \begin{align*}
    ...
    \intertext{and define the set of actions by (see \cref{12-fig-asym-undec})}
  ...
  variant, the arguments used in the proof of \cref{12-th-undec} apply
  similarly to show that it is also undecidable.
\end{proof}

In dimension~one, \cref{12-th-dim1} applies, thus "configuration
reachability" is decidable in \EXPSPACE.  This bound is actually
tight.
\begin{theorem}\label{12-th-asym-dim1}
  "Configuration reachability" "asymmetric vector games", both with
...
\begin{proof}
  ...
  proceed as in \cref{12-countdown-given,12-countdown-exist} and
  ...
  mostly the same as in \cref{12-countdown-given}, with a few changes.
