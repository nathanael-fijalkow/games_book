...
\begin{example}[vector system]\label{11-ex-mwg}
...
\begin{example}[natural semantics]\label{11-ex-sem}
...
\begin{example}[objectives]\label{11-ex-cov}
...
{Does \Eve\ have a strategy to avoid the "sink"~$\sink$ from
  ...
  \caption{The "winning region" of \Eve\ in the
    "non-termination" game on the graphs of \cref{11-fig:mwg,12-fig-sem}.}\label{11-fig-nonterm} 
\end{figure}

% \begin{example}
%   Consider the "non-termination" game on the graphs of
%   \cref{11-fig:mwg,12-fig-sem}.  \Eve's "winning region" is shown in
%   \cref{11-fig:nonterm}
% \end{example}
...
\begin{remark}\label{11-nonterm2parity}
...
\begin{theorem}\label{11-th-undec}
...
\begin{proof}
  ...
  \cref{11-pb-cov,12-pb-nonterm}% ; note regarding the latter that \Eve
