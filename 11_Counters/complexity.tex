...
\begin{proof}
  ...
  \begin{figure}[htbp]
    ...
    \caption{Schema of the reduction to
      "coverability" in the proof of \cref{11-avag-hard}.}\label{11-fig-lipton}
  \end{figure}
  ...
  \begin{figure}[htbp]
    ...
    \end{tikzpicture}
    \caption{Schema of the reduction to
      "non-termination" in the proof of \cref{11-avag-hard}.}\label{11-fig-lipton-nonterm}
  \end{figure}
...
\begin{proof}
  ...
  \begin{figure}[htbp]
    ...
    of \cref{11-avag-two}.}\label{11-fig-dim2}
  \end{figure}
...
%\input{sec-avag-dim1}
\TODO{contents of \cref{11-subsec:mono-dim1} depend on what goes into \cref{12-chap:multiobjective}}
