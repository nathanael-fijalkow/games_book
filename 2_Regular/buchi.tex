...
\begin{theorem}[Positional determinacy and complexity of Buchi games]
\label{2-thm:Buchi}
...
\begin{lemma}[Fixed point characterisation of the winning region for Buchi games]
...
\begin{lemma}[Second fixed point characterisation of the winning region for Buchi games]
\label{2-lem:Buchi}
